...
#       Development board, in SFP1+SFP2 aurora ports
#    Run with: vivado -mode batch -source ku041.tcl
...
lappend RTLs ${TOP}/boards/ku040/aurora-dual-sfp1-sfp2.v
