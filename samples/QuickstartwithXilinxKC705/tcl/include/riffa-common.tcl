...
#
# This file is to:
#    setup RIFFA based project with Xilinx FPGAs
# ----------------------------------------------------------------------

set RTLs [ concat $RTLs \
               [ list \
                     ${TOP}/pcie/riffa/src-riffa/shiftreg.v \
                     ${TOP}/pcie/riffa/src-riffa/functions.vh \
                     ...
                     ${TOP}/pcie/riffa/src-riffa/types.vh \
                     ${TOP}/pcie/riffa/src-riffa/trellis.vh \
                     ${TOP}/pcie/riffa/src-riffa/widths.vh \
                     ...
                     ${TOP}/pcie/riffa/src-riffa/schedules.vh \
                     ...
                     ${TOP}/pcie/riffa/src-riffa/ultrascale.vh \
                     ${TOP}/pcie/riffa/src-riffa/txr_engine_ultrascale.v \
                     ${TOP}/pcie/riffa/src-riffa/tlp.vh \
                     ...
                     ${TOP}/pcie/riffa/src-riffa/riffa.vh \
                     ...
                     ${TOP}/pcie/riffa/src-riffa/xilinx.vh \
